...
function usage() {
  return [
    "Usage: node tests/release/native-runtime-watchdog-matrix.mjs --browser FILE --driver FILE --release-harness-module FILE --private-key-file FILE --key-id ID --output DIR [options]",
    "",
...
function parseArgs(argv) {
  ...
  for (const field of ["browser", "driver", "releaseHarnessModule", "privateKeyFile", "keyId", "output"]) {
