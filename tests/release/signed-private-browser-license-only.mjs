...
function usage() {
  return [
    "Usage: node tests/release/signed-private-browser-license-only.mjs --browser FILE --driver FILE --license FILE --private-key-file FILE --key-id ID --output DIR [options]",
    "",
...
function parseArgs(argv) {
  ...
  for (const field of ["browser", "driver", "license", "privateKeyFile", "keyId", "output"]) {
