...
Current release archives use 7z. Install `7z` (or `7zz` on Unix-like systems), or set `SLYBROWSER_7Z_PATH` to the executable before using the automatic installer.
...
`docs/authorized-release-service.md` for the public authorization and release flow.
