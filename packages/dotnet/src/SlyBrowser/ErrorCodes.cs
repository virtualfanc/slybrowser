...
{
    public static IReadOnlyList<string> LicenseService { get; } = Array.AsReadOnly(new[]
    {
    ...
    private static readonly HashSet<string> LicenseServiceSet = new(LicenseService, StringComparer.Ordinal);

    public static bool IsLicenseServiceErrorCode(string code) => LicenseServiceSet.Contains(code);
}
