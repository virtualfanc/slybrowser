...
public static class BrowserInstaller
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string archive = Path.Combine(downloads, $"{grant.Artifact.Sha256}.zip");
        ...
        try
        {
            ...
            else await SafeExtractAsync(archive, temporaryDirectory, MaximumExpandedBytes(grant.Artifact.Size), cancellationToken);
