...
import { createPortableLicenseFile, createTestLicenseFile } from "../../license-service/src/license-file.js";
...
describe("authorized release client", () => {
  ...
  it("schedules client heartbeats with negative jitter", () => {
    expect(heartbeatDelayMilliseconds(300, () => 0)).toBe(300_000);
    expect(heartbeatDelayMilliseconds(300, () => 1)).toBe(285_000);
    expect(heartbeatDelayMilliseconds(300, () => 0.5)).toBe(292_500);
    expect(heartbeatDelayMilliseconds(5, () => 1)).toBe(1_000);
  });
  ...
  it("reads encrypted/authenticated v2 test license files and fails closed on tampering", async () => {
    ...
    const licenseDocument = createTestLicenseFile({
      licenseId: "00000000-0000-4000-8000-000000000002",
      licenseKey: `sly_live_00000000-0000-4000-8000-000000000002.${"x".repeat(43)}`,
      serviceUrl: "https://api.slybrowser.test",
    ...
    const portableDocument = createPortableLicenseFile({
    ...
    const expiredDocument = createTestLicenseFile({
      licenseId: "00000000-0000-4000-8000-000000000002",
      licenseKey: `sly_live_00000000-0000-4000-8000-000000000002.${"x".repeat(43)}`,
      serviceUrl: "https://api.slybrowser.test",
    ...
    const planClaimDocument = createTestLicenseFile({
      licenseId: "00000000-0000-4000-8000-000000000002",
      licenseKey: `sly_live_00000000-0000-4000-8000-000000000002.${"x".repeat(43)}`,
      serviceUrl: "https://api.slybrowser.test",
      issuedAt: "2033-05-18T03:33:20.000Z",
  ...
  it.skipIf(process.platform !== "win32")("imports v2 license files into Windows DPAPI sealed authorization files", async () => {
    ...
    const licenseDocument = createPortableLicenseFile({
