...
foreach ($mode in $modes) {
    ...
    $previousCacheRoot = $env:SLYBROWSER_INTEGRATION_CACHE_ROOT
    $previousLicenseKeyId = $env:SLYBROWSER_INTEGRATION_LICENSE_KEY_ID
    $previousLicensePublicKeyHex = $env:SLYBROWSER_INTEGRATION_LICENSE_PUBLIC_KEY_HEX
    $previousReleaseKeyId = $env:SLYBROWSER_INTEGRATION_RELEASE_KEY_ID
    $previousReleasePublicKey = $env:SLYBROWSER_INTEGRATION_RELEASE_PUBLIC_KEY_BASE64URL
    ...
    try {
        ...
        $env:SLYBROWSER_INTEGRATION_CACHE_ROOT = $cachePath
        $env:SLYBROWSER_INTEGRATION_LICENSE_KEY_ID = $LicenseKeyId
        $env:SLYBROWSER_INTEGRATION_LICENSE_PUBLIC_KEY_HEX = $LicensePublicKeyHex
        $env:SLYBROWSER_INTEGRATION_RELEASE_KEY_ID = $ReleaseKeyId
        $env:SLYBROWSER_INTEGRATION_RELEASE_PUBLIC_KEY_BASE64URL = $ReleasePublicKeyBase64url
        ...
        $env:SLYBROWSER_INTEGRATION_CACHE_ROOT = $previousCacheRoot
        $env:SLYBROWSER_INTEGRATION_LICENSE_KEY_ID = $previousLicenseKeyId
        $env:SLYBROWSER_INTEGRATION_LICENSE_PUBLIC_KEY_HEX = $previousLicensePublicKeyHex
        $env:SLYBROWSER_INTEGRATION_RELEASE_KEY_ID = $previousReleaseKeyId
        $env:SLYBROWSER_INTEGRATION_RELEASE_PUBLIC_KEY_BASE64URL = $previousReleasePublicKey
