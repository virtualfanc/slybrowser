...
SlyBrowser supports PayNow.gg and a self-hosted crypto payment flow. This public document describes customer-visible behavior only. Provider credentials, product IDs, webhook validation, database code, reconciliation, refunds, and deployment procedures live in the private website repository.
